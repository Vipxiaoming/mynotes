...
export default hopeTheme({
  // 当前网站部署到的域名
  hostname: "https://gitee.com/wxxxax",

  // 文章显示的默认作者
  author: {
    name: "Wang.Xiaoming",
    url: "https://gitee.com/wxxxax",
  },
  ...
  // 文章所在仓库
  docsRepo: "https://gitee.com/wxxxax/mynotes.git",
